...
class server(object):
    ...
    def round(self):
        ...
        if functions.stage(int(pkmn1[6]), int(pkmn1[15])) > functions.stage(int(pkmn2[6]), int(pkmn2[15])):
            ...
            if mv1[2] == "Physical":
                if mv2[2] == "Physical":
                    dmg1 = damage(functions.damage(int(pkmn1[7]), int(mv1[5]), functions.stage(int(pkmn1[2]), int(pkmn1[11])), functions.stage(int(pkmn2[3]), int(pkmn2[12])), functions.modifier("", "", int(pkmn1[8]), pkmn1[17], mv1[1], False, pkmn2[17], False)))
                    dmg = dmg1
                    exec(mv1[6])
                    exec(mv1[7])
                    dmg2 = damage(functions.damage(int(pkmn2[7]), int(mv2[5]), functions.stage(int(pkmn2[2]), int(pkmn2[11])), functions.stage(int(pkmn1[3]), int(pkmn1[12])), functions.modifier("", "", int(pkmn2[8]), pkmn2[17], mv2[1], False, pkmn1[17], False)))
                    dmg = dmg2
                    exec(mv2[6])
                    exec(mv2[7])
                else:
                    ...
                    exec(mv1[6])
                    exec(mv1[7])
                    dmg2 = damage(functions.damage(int(pkmn2[7]), int(mv2[5]), functions.stage(int(pkmn2[4]), int(pkmn2[13])), functions.stage(int(pkmn1[5]), int(pkmn1[14])), functions.modifier("", "", int(pkmn2[8]), pkmn2[17], mv2[1], False, pkmn1[17], False)))
                    dmg = dmg2
                    exec(mv2[6])
                    exec(mv2[7])
            else:
                if mv2[2] == "Physical":
                    dmg1 = damage(functions.damage(int(pkmn1[7]), int(mv1[5]), functions.stage(int(pkmn1[4]), int(pkmn1[13])), functions.stage(int(pkmn2[5]), int(pkmn2[14])), functions.modifier("", "", int(pkmn1[8]), pkmn1[17], mv1[1], False, pkmn2[17], False)))
                    dmg = dmg1
                    exec(mv1[6])
                    exec(mv1[7])
                    dmg2 = damage(functions.damage(int(pkmn2[7]), int(mv2[5]), functions.stage(int(pkmn2[2]), int(pkmn2[11])), functions.stage(int(pkmn1[3]), int(pkmn1[12])), functions.modifier("", "", int(pkmn2[8]), pkmn2[17], mv2[1], False, pkmn1[17], False)))
